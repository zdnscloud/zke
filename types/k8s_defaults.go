...
var (
	...
	AllK8sVersions = map[string]ZKESystemImages{
		"v1.13.1": {
			...
			Alpine:                     m("zdnscloud/zke-tools:v0.1.40"),
			NginxProxy:                 m("zdnscloud/zke-tools:v0.1.40"),
			CertDownloader:             m("zdnscloud/zke-tools:v0.1.40"),
			KubernetesServicesSidecar:  m("zdnscloud/zke-tools:v0.1.40"),
			...
			StorageLvmCSI:              m("zdnscloud/lvmcsi:v0.5"),
			StorageLvmd:                m("zdnscloud/lvmd:v0.4"),
			...
			ClusterAgent:               m("zdnscloud/cluster-agent:v1.3"),
			...
			ZKERemover:                 m("zdnscloud/zke-remove:v0.3"),
		},
	}
)
