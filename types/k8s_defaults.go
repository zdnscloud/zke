...
var (
	...
	AllK8sVersions = map[string]ZKESystemImages{
		"v1.13.1": {
			...
			Alpine:                      m("zdnscloud/zke-tools:v0.1.27"),
			NginxProxy:                  m("zdnscloud/zke-tools:v0.1.27"),
			CertDownloader:              m("zdnscloud/zke-tools:v0.1.27"),
			KubernetesServicesSidecar:   m("zdnscloud/zke-tools:v0.1.27"),
			...
			StorageCSILvmplugin:         m("zdnscloud/lvmplugin:v0.7"),
