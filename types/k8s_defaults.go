...
var (
	...
	AllK8sVersions = map[string]ZKESystemImages{
		"v1.13.1": {
			...
			Alpine:                     m("zdnscloud/zke-tools:v0.1.37"),
			NginxProxy:                 m("zdnscloud/zke-tools:v0.1.37"),
			CertDownloader:             m("zdnscloud/zke-tools:v0.1.37"),
			KubernetesServicesSidecar:  m("zdnscloud/zke-tools:v0.1.37"),
