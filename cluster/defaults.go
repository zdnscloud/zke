...
func (c *Cluster) setClusterImageDefaults() error {
	...
	systemImagesDefaultsMap := map[*string]string{
		...
		&c.SystemImages.StorageLvmAttacher:         d(imageDefaults.StorageLvmAttacher, privRegURL),
		&c.SystemImages.StorageLvmProvisioner:      d(imageDefaults.StorageLvmProvisioner, privRegURL),
		&c.SystemImages.StorageLvmDriverRegistrar:  d(imageDefaults.StorageLvmDriverRegistrar, privRegURL),
		...
		&c.SystemImages.StorageCephAttacher:        d(imageDefaults.StorageCephAttacher, privRegURL),
		&c.SystemImages.StorageCephProvisioner:     d(imageDefaults.StorageCephProvisioner, privRegURL),
		&c.SystemImages.StorageCephDriverRegistrar: d(imageDefaults.StorageCephDriverRegistrar, privRegURL),
		&c.SystemImages.StorageCephFsCSI:           d(imageDefaults.StorageCephFsCSI, privRegURL),
	}
