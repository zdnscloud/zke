...
var (
	...
	AllK8sVersions = map[string]ZKESystemImages{
		"v1.13.1": {
			...
			Alpine:                      m("zdnscloud/zke-tools:v0.1.35"),
			NginxProxy:                  m("zdnscloud/zke-tools:v0.1.35"),
			CertDownloader:              m("zdnscloud/zke-tools:v0.1.35"),
			KubernetesServicesSidecar:   m("zdnscloud/zke-tools:v0.1.35"),
