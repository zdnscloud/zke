...
var (
	...
	AllK8sVersions = map[string]ZKESystemImages{
		"v1.13.1": {
			...
			PrometheusAlertManager:      ("prom/alertmanager:v0.14.0"),
			PrometheusConfigMapReloader: ("jimmidyson/configmap-reload:v0.1"),
			PrometheusNodeExporter:      ("prom/node-exporter:v0.15.2"),
			PrometheusServer:            ("prom/prometheus:v2.2.1"),
			Grafana:                     ("grafana/grafana:5.0.0"),
			GrafanaWatcher:              ("quay.io/coreos/grafana-watcher:v0.0.8"),
			KubeStateMetrics:            ("quay.io/coreos/kube-state-metrics:v1.3.1"),
		},
	}
)
